  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved aluno as @aluno" do
        ...
        post :create, {:aluno => { "name" => "invalid value" }}, valid_session
        assigns(:aluno).should be_a_new(Aluno)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested aluno" do
        ...
        Aluno.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => aluno.to_param, :aluno => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the aluno as @aluno" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Aluno.any_instance.stub(:save).and_return(false)
        put :update, {:id => aluno.to_param, :aluno => { "name" => "invalid value" }}, valid_session
        assigns(:aluno).should eq(aluno)
      end
